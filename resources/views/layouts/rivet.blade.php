                            ...
                            <div data-rvt-disclosure="menu" data-rvt-close-click-outside>
                                ...
                                <nav aria-label="Main" class="rvt-header-menu" data-rvt-disclosure-target="menu" hidden>
                                    <ul class="rvt-header-menu__list">
                                        ...
                                        <a class="rvt-header-menu__link" href="{{route(falloutRandomizer)}}">Fallout Special Stat Randomizer</a>
                                        </li>
                                        <!-- Navigation link marked as the current page -->
                                        <li class="rvt-header-menu__item rvt-header-menu__item--current">
                                        <a class="rvt-header-menu__link" href="{{route(tipCalc)}}" aria-current="page">Tip Calculator</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
